      ...
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
          <div class="position-relative h-100">
            <img class="img-fluid position-absolute w-100 h-100" src="./backend/image/<?php echo $rw[4];?>" alt=""
              style="object-fit: cover;">
          </div>
        </div>
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
          <h6 class="section-title bg-white text-start title-color pe-3">Your Tour</h6>
          <h1 class="mb-4"><?php echo $rw[2];?></h1>
          <p class="mb-4"><?php echo $rw[3];?></p>
          <!-- <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos.
            Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p> -->
          <div class="row gy-2 gx-4 mb-4">
            <div class="col-sm-6">
              <p class="mb-0"><i class="fa fa-arrow-right title-color me-2"></i>Price:- <?php echo $rw[10];?></p>
            </div><br><br>
            <div class="col-sm-6">
              <p class="mb-0"><i class="fa fa-arrow-right title-color me-2"></i>Start Date:- <?php echo $rw[7];?></p>
            </div><br>
            <div class="col-sm-6">
              <p class="mb-0"><i class="fa fa-arrow-right title-color me-2"></i>End Date:- <?php echo $rw[8];?></p>
            </div>
            <div class="col-sm-6">
              <p class="mb-0"><i class="fa fa-arrow-right title-color me-2"></i>Last Date to Book your Seats:-<br>&nbsp&nbsp&nbsp&nbsp <?php echo $rw[9];?></p>
            </div>
            <!-- <div class="col-sm-6">
          ...
          <button class="btn btn-danger"> <a  href="booknow.php?id=<?php echo $rw[0];?>" style="color:white; text-decoration:none;">Book Now</a></button>
        </div>
      </div>
    </div>
  </div>
                ...
                <td id="seat12" data-name="C">C
                    ...
                    <td style="float:right;" id="seat23" data-name="33">33
                            ...
                            <div class="col-6 ">
                                ...
                                <div class="col-auto">
                                    <input type="text" id="seatInput" class="form-control" name="seatInput" required>
                                </div>
                                <div class="col-auto">
